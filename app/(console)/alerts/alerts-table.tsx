      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {hasFilter && (
          <Button
            variant="ghost"
            size="sm"
            onClick={() => { setAssetFilter(new Set()); setStatusFilter(new Set()); setCvssFilter(new Set()); setKevFilter(new Set()); setEcosystemFilter(new Set()); setSourcesFilter(new Set()); setVulnIdFilter("") }}
          >
